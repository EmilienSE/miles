...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $mail = 'miles.contactus@gmail.com'; // Déclaration de l'adresse de destination.
  ...
  $nom = htmlentities($_POST['name'], ENT_QUOTES, "UTF-8");
  $email = htmlentities($_POST['email'], ENT_QUOTES, "UTF-8");
  $telephone = htmlentities($_POST['phone'], ENT_QUOTES, "UTF-8");
  $subject = htmlentities($_POST['subject'], ENT_QUOTES, "UTF-8");
  $commentaire = htmlentities($_POST['message'], ENT_QUOTES, "UTF-8");
...
<script type="colorScheme" class="swatch active">
{
  ...
  <tbody>
    <tr>
      <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable">
                                  <p style=\'text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;\'><span class="specbundle2"><span class="font1">Bonjour Emilien,</span></span></p>
                                </div>
                              </div></td>
    </tr>
  </tbody>
    ...
    $message_html .= '<h2>Vous avez une nouvelle demande de contact de la part de '.strtoupper($nom).'.</h2>';
    $message_html .= '</div>
                              </div>
                            </td>
                          </tr>
